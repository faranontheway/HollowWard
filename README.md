# 👁️ HollowWard – Multiplayer Horror Game (Roblox)
...
3. Import scripts into their respective services:

   * `ServerScriptService`
   * `StarterPlayerScripts`
   * `ReplicatedStorage`
4. Follow detailed steps in **SETUP_GUIDE.md**
5. Run the game in Play mode 🎮
